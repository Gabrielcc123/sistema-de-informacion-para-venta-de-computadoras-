...
<aside class="fixed left-0 top-0 h-full w-64 bg-gray-100 dark:bg-[#202022] border-r border-gray-200 dark:border-gray-800 flex flex-col z-50">
    ...
    <div class="px-6 py-6 mb-4">
        <div class="flex items-center gap-2 mb-2">
            <img src="{{ asset('img/logo.png') }}" alt="Logo Iris Computer" class="w-10 h-10 object-contain">
    ...
    <nav class="flex-1 overflow-y-auto px-3 space-y-1">
        ...
        <a href="{{ route('dashboard') }}" wire:navigate
           ...
           {{ request()->routeIs('dashboard') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
        ...
        <a href="{{ route('usuarios.index') }}" wire:navigate
           class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
           {{ request()->routeIs('usuarios.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
            <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('reportes.index') }}" wire:navigate
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
               {{ request()->routeIs('reportes.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('bitacora.index') }}" wire:navigate
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
               {{ request()->routeIs('bitacora.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('ventas.index') }}" wire:navigate
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
               {{ request()->routeIs('ventas.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('ordenes.index') }}" wire:navigate
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
               {{ request()->routeIs('ordenes.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        {{-- Equipos: visible para los 3 roles --}}
        @endif

        @if(Auth::user()->tipoSupervisor || Auth::user()->tipoAssesor || Auth::user()->tipoTecnico)
            <a href="{{ route('equipos.index') }}" wire:navigate
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
               {{ request()->routeIs('equipos.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        @if(Auth::user()->tipoSupervisor)
            <a href="{{ route('inventario.index') }}" wire:navigate
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
               {{ request()->routeIs('inventario.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('categorias.index') }}" wire:navigate
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
               {{ request()->routeIs('categorias.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        @elseif(Auth::user()->tipoTecnico)
            ...
            <a href="{{ route('ordenes.mis-ordenes') }}" wire:navigate
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
               {{ request()->routeIs('ordenes.*') ? 'bg-cyan-400/10 text-cyan-400 border-r-2 border-cyan-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#262629]' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.032 4.032m-1.745 1.437l.102.085" />
    ...
    <div class="mt-auto px-4 py-4 border-t border-gray-200 dark:border-gray-800">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div class="overflow-hidden">
                <p class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">{{ $user->nombre }} {{ $user->apellido }}</p>
                <p class="text-xs text-gray-500 truncate">{{ $rol }}</p>
            </div>
        </div>
