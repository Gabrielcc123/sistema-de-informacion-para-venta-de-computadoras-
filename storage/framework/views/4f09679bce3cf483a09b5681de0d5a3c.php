    ...
    <div id="recibo-imprimir" class="bg-[#202022] border border-gray-800 rounded-xl p-8 max-w-4xl mx-auto">
        ...
        <div class="text-center border-b border-gray-800 pb-6 mb-6">
            <div class="flex flex-col items-center justify-center gap-2 mb-2">
                <img src="<?php echo e(asset('img/logoP.png')); ?>" alt="Logo Syscraft" class="w-12 h-12 object-contain">
            ...
            <p class="text-sm text-gray-400 mt-1">Nro. <span class="font-mono font-bold text-cyan-400">#<?php echo e($venta->nroNotaVenta); ?></span></p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="space-y-2">
                ...
                <p class="text-sm text-gray-100 font-medium"><?php echo e($venta->fecha); ?></p>
            </div>
            <div class="space-y-2">
                <p class="text-xs font-mono text-gray-500 uppercase tracking-wider">Método de Pago</p>
                <p class="text-sm text-gray-100 font-medium"><?php echo e($venta->pago?->tipoPago ?? '—'); ?></p>
            </div>
            <div class="space-y-2">
                ...
                <p class="text-sm text-gray-100 font-medium">
                    <?php echo e($venta->usuario?->nombre); ?> <?php echo e($venta->usuario?->apellido); ?>
        ...
        <div class="bg-[#161618] border border-gray-800 rounded-lg p-5 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                    ...
                    <span class="text-gray-100 ml-1 font-mono"><?php echo e($venta->cliente?->ci ?? '—'); ?></span>
                </div>
                <div>
                    <span class="text-gray-500">Teléfono:</span>
                    <span class="text-gray-100 ml-1"><?php echo e($venta->cliente?->telefono ?? '—'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto mb-6">
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-800 text-gray-300">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $venta->detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td class="px-4 py-3 whitespace-nowrap text-center font-mono text-gray-100"><?php echo e($detalle->cantidad); ?></td>
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detalle->productoServicio?->tipo === 'Servicio'): ?>
                                    ...
                                    <span class="text-gray-100"><?php echo e($detalle->productoServicio?->nombre ?? '—'); ?></span>
                                </div>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap text-right font-mono text-gray-100">
                                Bs. <?php echo e(number_format($detalle->precioUnitario, 2)); ?>

                            </td>
                            <td class="px-4 py-3 whitespace-nowrap text-right font-mono font-bold text-cyan-400">
                                Bs. <?php echo e(number_format($detalle->subTotal, 2)); ?>
        ...
        <div class="flex items-center justify-end border-t border-gray-800 pt-6">
            <div class="text-right">
                ...
                <p class="text-4xl font-bold text-cyan-400">Bs. <?php echo e(number_format($venta->total, 2)); ?></p>
            </div>
        </div>
...
</div><?php /**PATH /home/gabriel/Escritorio/Metodologia/sistema-de-informacion-para-venta-de-computadoras-/resources/views/livewire/ventas/detalle.blade.php ENDPATH**/ ?>