...
<div class="space-y-6">
    ...
    <div class="bg-[#202022] border border-gray-800 rounded-xl overflow-hidden">
                        ...
                        <tr class="hover:bg-[#262629] transition-colors">
                            <td class="px-5 py-3 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-lg bg-cyan-400/10 text-cyan-400 flex items-center justify-center font-bold text-xs border border-cyan-400/30">
                                        <?php echo e(strtoupper(substr($categoria->nombre, 0, 2))); ?>

                                    </div>
                                    <div>
                                        <div class="font-medium text-gray-100"><?php echo e($categoria->nombre); ?></div>
                                        <div class="text-xs text-gray-500">ID: <?php echo e($categoria->idCategoria); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-5 py-3 text-sm text-gray-400 max-w-xs truncate"><?php echo e($categoria->descripcion ?? '—'); ?></td>
                            <td class="px-5 py-3 text-center">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-cyan-400/10 text-cyan-400 border border-cyan-400/30">
                                    <?php echo e($categoria->productos_servicios_count); ?>

                                </span>
                            </td>
                            <td class="px-5 py-3 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button wire:click="abrirModal(<?php echo e($categoria->idCategoria); ?>)"
                                    ...
                                    <button wire:click="eliminar(<?php echo e($categoria->idCategoria); ?>)"
                                            wire:confirm="¿Está seguro de eliminar la categoría <?php echo e($categoria->nombre); ?>?"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($categorias->hasPages()): ?>
            <div class="px-5 py-4 border-t border-gray-800 bg-[#161618]">
                <?php echo e($categorias->links(data: ['scrollTo' => false])); ?>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm"
            ...
            <div class="bg-[#202022] border border-gray-800 rounded-xl p-6 w-full max-w-lg shadow-2xl mx-4">
                <h3 class="text-lg font-bold text-gray-100 mb-1">
                    <?php echo e($modoEdicion ? 'Editar Categoría' : 'Nueva Categoría'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex items-center gap-3 mt-6">
                    ...
                    <button wire:click="guardar"
                        ...
                        <?php echo e($modoEdicion ? 'Guardar Cambios' : 'Registrar Categoría'); ?>
...
</div><?php /**PATH C:\Users\VICTUS\OneDrive\Desktop\Metodologia\Fase3 - bitacora , login , requisotos de password - copia\resources\views\livewire/categorias/index.blade.php ENDPATH**/ ?>