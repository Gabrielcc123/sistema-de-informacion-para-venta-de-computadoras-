...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <a href="<?php echo e(route('usuarios.crear')); ?>" wire:navigate
    ...
    <div class="bg-[#202022] border border-gray-800 rounded-xl overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-800 text-gray-300">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-[#262629] transition-colors">
                            <td class="px-5 py-3 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-full bg-cyan-400/10 text-cyan-400 flex items-center justify-center font-bold text-xs border border-cyan-400/30">
                                        <?php echo e(strtoupper(substr($usuario->nombre, 0, 1) . substr($usuario->apellido, 0, 1))); ?>

                                    </div>
                                    <div>
                                        <div class="font-medium text-gray-100"><?php echo e($usuario->nombre); ?> <?php echo e($usuario->apellido); ?></div>
                                        <div class="text-xs text-gray-500">ID: <?php echo e($usuario->idUsuario); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-5 py-3 whitespace-nowrap text-gray-100"><?php echo e($usuario->email); ?></td>
                            <td class="px-5 py-3 whitespace-nowrap"><?php echo e($usuario->telefono ?? '—'); ?></td>
                            <td class="px-5 py-3 whitespace-nowrap">
                                <div class="flex flex-wrap gap-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($usuario->tipoSupervisor): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($usuario->tipoAssesor): ?>
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($usuario->tipoTecnico): ?>
                            ...
                            <td class="px-5 py-3 whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($usuario->estado): ?>
                            ...
                            <td class="px-5 py-3 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button wire:click="toggleEstado(<?php echo e($usuario->idUsuario); ?>)"
                                            class="px-3 py-1.5 text-xs font-medium rounded border transition-all duration-200
                                            <?php echo e($usuario->estado ? 'border-red-400/30 text-red-400 hover:bg-red-400/10' : 'border-emerald-400/30 text-emerald-400 hover:bg-emerald-400/10'); ?>">
                                        <?php echo e($usuario->estado ? 'Suspender' : 'Activar'); ?>

                                    </button>
                                    <button wire:click="abrirModalReset(<?php echo e($usuario->idUsuario); ?>)"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($usuarios->hasPages()): ?>
            <div class="px-5 py-4 border-t border-gray-800 bg-[#161618]">
                <?php echo e($usuarios->links(data: ['scrollTo' => false])); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mostrarModalReset): ?>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input wire:model="nuevaPassword" type="password"
                               ...
                               placeholder="••••••••">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nuevaPassword'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input wire:model="nuevaPasswordConfirm" type="password"
                               class="w-full bg-[#161618] border border-gray-800 text-gray-100 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/50 transition-all placeholder:text-gray-600"
                               placeholder="••••••••">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nuevaPasswordConfirm'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-400 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
</div><?php /**PATH C:\Users\VICTUS\OneDrive\Desktop\Metodologia\Fase3 - bitacora , login , requisotos de password - copia\resources\views\livewire/usuarios/index.blade.php ENDPATH**/ ?>