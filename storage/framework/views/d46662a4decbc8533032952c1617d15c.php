...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between mb-2">
        ...
        <a href="<?php echo e(route('ventas.crear')); ?>" wire:navigate
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-[#202022] border border-gray-800 rounded-xl p-5 relative overflow-hidden group hover:border-gray-700 transition-all">
            ...
            <div class="text-3xl font-bold text-gray-100 mb-1">Bs. <?php echo e(number_format($montoHoy, 2)); ?></div>
            <div class="text-xs text-cyan-400"><?php echo e($ventasHoy); ?> venta(s) registrada(s)</div>
        </div>
        ...
        <div class="bg-[#202022] border border-gray-800 rounded-xl p-5 relative overflow-hidden group hover:border-gray-700 transition-all">
            ...
            <div class="text-3xl font-bold text-gray-100 mb-1"><?php echo e($clientesAtendidos); ?></div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-800 text-gray-300">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ultimasVentas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-[#262629] transition-colors">
                            <td class="px-5 py-3 whitespace-nowrap">
                                <a href="<?php echo e(route('ventas.detalle', $venta->nroNotaVenta)); ?>" wire:navigate
                                   class="font-mono text-cyan-400 hover:underline">#<?php echo e($venta->nroNotaVenta); ?></a>
                            </td>
                            ...
                            <td class="px-5 py-3 whitespace-nowrap font-mono font-medium text-gray-100">
                                Bs. <?php echo e(number_format($venta->total, 2)); ?>

                            </td>
                            <td class="px-5 py-3 whitespace-nowrap">
                                <span class="inline-flex px-2 py-0.5 rounded text-xs font-semibold bg-cyan-400/10 text-cyan-400 border border-cyan-400/20">
                                    <?php echo e($venta->pago?->tipoPago ?? '—'); ?>

                                </span>
                            </td>
                            <td class="px-5 py-3 whitespace-nowrap text-gray-500"><?php echo e($venta->fecha); ?></td>
                        </tr>
...
<?php endif; ?><?php /**PATH C:\Users\VICTUS\OneDrive\Desktop\Metodologia\Fase3 - bitacora , login , requisotos de password - copia\resources\views/livewire/dashboard/vendedor.blade.php ENDPATH**/ ?>