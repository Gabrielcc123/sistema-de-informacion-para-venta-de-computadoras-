                ...
                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    <div class="flex-1 space-y-3">
                        <div class="flex items-center gap-3">
                            <span class="font-mono text-cyan-400 text-sm font-bold">#<?php echo e($orden->idOrden); ?></span>
                            <span class="inline-flex px-2 py-0.5 rounded text-xs font-semibold border <?php echo e($estadoColors[$orden->estado] ?? 'bg-gray-400/10 text-gray-400 border-gray-400/20'); ?>">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm">
                            <div>
                                ...
                                <span class="text-gray-100 ml-1"><?php echo e($orden->equipo?->marca ?? '—'); ?> <?php echo e($orden->equipo?->modelo ?? ''); ?></span>
                            </div>
                            <div>
                                <span class="text-gray-500">Serie:</span>
                                <span class="text-gray-300 font-mono text-xs ml-1"><?php echo e($orden->equipo?->numeroSerie ?? '—'); ?></span>
                            </div>
                            <div>
                                <span class="text-gray-500">Cliente:</span>
                                <span class="text-gray-100 ml-1"><?php echo e($orden->notaVenta?->cliente?->nombre ?? '—'); ?> <?php echo e($orden->notaVenta?->cliente?->apellido ?? ''); ?></span>
                            </div>
                            <div>
                                <span class="text-gray-500">Gama:</span>
                                <span class="text-gray-300 ml-1"><?php echo e($orden->equipo?->gama ?? '—'); ?></span>
                            </div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orden->equipo?->descripcion): ?>
                            <div class="bg-[#161618] border border-gray-800 rounded-lg px-4 py-2 text-sm">
                                ...
                                <p class="text-gray-300 mt-1"><?php echo e($orden->equipo->descripcion); ?></p>
                            </div>
                    ...
                    <div class="flex flex-col gap-2 min-w-[200px]">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($estadoSiguiente[$orden->estado])): ?>
                            <button wire:click="cambiarEstado(<?php echo e($orden->idOrden); ?>, '<?php echo e($estadoSiguiente[$orden->estado]); ?>')"
                                ...
                                Pasar a: <?php echo e($estadoSiguiente[$orden->estado]); ?>

                            </button>
                        <?php elseif($orden->estado === 'Finalizado'): ?>
...
</div><?php /**PATH C:\Users\VICTUS\OneDrive\Desktop\Metodologia\Fase3 - bitacora , login , requisotos de password - copia\resources\views\livewire/ordenes/mis-ordenes.blade.php ENDPATH**/ ?>