...
<aside class="fixed left-0 top-0 h-full w-64 bg-gray-100 dark:bg-[#202022] border-r border-gray-200 dark:border-gray-800 flex flex-col z-50">
    ...
    <div class="px-6 py-6 mb-4">
        <div class="flex items-center gap-2 mb-2">
            <img src="<?php echo e(asset('img/logoP.png')); ?>" alt="Logo Syscraft" class="w-10 h-10 object-contain">
            <div class="flex flex-col">
                <span class="text-xl font-bold text-gray-100 tracking-wider">SYSCRAFT</span>
                <span class="text-red-500 text-[9px] font-semibold tracking-widest uppercase">ERP</span>
            </div>
        </div>
    </div>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH /home/gabriel/Escritorio/Metodologia/sistema-de-informacion-para-venta-de-computadoras-/resources/views/components/layouts/sidebar.blade.php ENDPATH**/ ?>