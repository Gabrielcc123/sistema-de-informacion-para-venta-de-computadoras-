...
<div class="space-y-6">
    ...
    <div class="bg-[#202022] border border-gray-800 rounded-xl overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-800 text-gray-300">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ordenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orden): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-[#262629] transition-colors">
                            <td class="px-5 py-3 whitespace-nowrap font-mono text-cyan-400 text-xs">#<?php echo e($orden->idOrden); ?></td>
                            <td class="px-5 py-3 whitespace-nowrap text-gray-100"><?php echo e($orden->notaVenta?->cliente?->nombre ?? '—'); ?> <?php echo e($orden->notaVenta?->cliente?->apellido ?? ''); ?></td>
                            <td class="px-5 py-3 whitespace-nowrap"><?php echo e($orden->equipo?->marca ?? '—'); ?> <?php echo e($orden->equipo?->modelo ?? ''); ?></td>
                            <td class="px-5 py-3 whitespace-nowrap"><?php echo e($orden->tecnico?->nombre ?? '—'); ?> <?php echo e($orden->tecnico?->apellido ?? ''); ?></td>
                            <td class="px-5 py-3 whitespace-nowrap">
                                <span class="inline-flex px-2 py-0.5 rounded text-xs font-semibold border <?php echo e($estadoColors[$orden->estado] ?? 'text-gray-400 border-gray-400/20 bg-gray-400/10'); ?>">
                                    <?php echo e($orden->estado); ?>

                                </span>
                            </td>
                            <td class="px-5 py-3 whitespace-nowrap text-gray-500 text-xs"><?php echo e($orden->created_at?->format('d/m/Y') ?? '—'); ?></td>
                        </tr>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ordenes->hasPages()): ?>
            <div class="px-5 py-4 border-t border-gray-800 bg-[#161618]">
                <?php echo e($ordenes->links(data: ['scrollTo' => false])); ?>

            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div><?php /**PATH /home/gabriel/Escritorio/Metodologia/sistema-de-informacion-para-venta-de-computadoras-/resources/views/livewire/ordenes/index.blade.php ENDPATH**/ ?>